...
![Protobuf](https://img.shields.io/badge/Protobuf-244c5a?logo=protocol-buffers&logoColor=white)
![Docker](https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white)
![Fly.io](https://img.shields.io/badge/Fly.io-24185B?logo=fly.io&logoColor=white)

A production-grade GPS event pipeline built with Go, Kafka, Cassandra, Redis, and WebSockets, alongside a Next.js React dashboard.
